...
startup, and with the plugin absent no class from it is ever loaded.

| Page | What it covers |
|---|---|
| [Overview](overview.md) | Every detected plugin, by family, and what it turns on |
| [Vault and Treasury](vault-treasury.md) | Serving our economy to other plugins, and reading theirs |
| [PlaceholderAPI](placeholderapi.md) | The placeholders we publish, and resolving other plugins' inside our text |
