...
| `ECOITEM` | EcoItems | The EcoItems id | — |
| `EXECITEM` | ExecutableItems | The item id | — |
| `IAITEM` | ItemsAdder | The item id | — |
| `NEXO` | Nexo | The item id | — |
| `SKULL` | — built in | A player name | — |
| `SAVE` | — built in | A saved item key | — |
| `CUSTOMREQ` | — built in | An editor profile id | — |
